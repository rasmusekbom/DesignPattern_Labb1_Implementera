...
namespace Labb1_Implementera.Boats.Models
{
    class FishingBoat : IBoat
    {
        ...
        public static string runmenu()
        {
            ...
            Console.WriteLine("Would you want a slow, medium or highspeed fishing boat?" +
                "\nSome boats are good for lakefishing, some for oceanfishing. \nPlease choose with the correct number followed by Enter."
                + "\n1) Slow Speed Boat" +
                "\n2) Medium Speed Boat" +
                "\n3) High Speed Boat");
